package com.nemostation.android.fulllolwallpaper.fragments;
...
import com.nemostation.android.fulllolwallpaper.BaseActivity;
import com.nemostation.android.fulllolwallpaper.FullScreenGalleryActivity;
import com.nemostation.android.fulllolwallpaper.R;
import com.nemostation.android.fulllolwallpaper.util.ImageViewUtil;
import com.nemostation.android.fulllolwallpaper.MainActivity;
...
public class FullScreenGalleryFragment extends Fragment implements
	...
	public static final String FULL_SCREEN_GALLERY_CATEGORY = "com.nemostation.android.fulllolwallpaper.FullScreenGalleryActivity."
			+ "FullScreenGalleryFragment.category";
	public static final String FULL_SCREEN_GALLERY_IMAGE = "com.nemostation.android.fulllolwallpaper.FullScreenGalleryActivity."
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.full_screen_gallery_item, container, false);
		...
		switch (v.getId()) {
            ...
            case R.id.full_screen_gallery_item_download:
                if ( MainActivity.verifyStoragePermissions(getActivity())) {
                    ...
                    if (getActivity() != null) {
                        ((BaseActivity) getActivity())
                                .showToast("Please allow this app to access media. And Download again!");
                    }
                }
                break;
