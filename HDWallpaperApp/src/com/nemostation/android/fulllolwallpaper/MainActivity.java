...
import com.nemostation.android.fulllolwallpaper.adapters.GridImageAdapter;
import com.nemostation.android.fulllolwallpaper.models.Categories;
import com.nemostation.android.fulllolwallpaper.models.Category;
import com.nemostation.android.fulllolwallpaper.models.Recent;
import com.nemostation.android.fulllolwallpaper.util.Controller;
import com.nemostation.android.fulllolwallpaper.util.DataHolder;
import com.nemostation.android.fulllolwallpaper.util.DialogUtils;
...
public class MainActivity extends NavigationDrawerActivity implements
	...
	public static final String PARC_RECENT = "com.nemostation.android.fulllolwallpaper.Recent";
	public static final String PARC_FAVOURITES = "com.nemostation.android.fulllolwallpaper.Favourites";
	public static final String PARC_CATEGORIES = "com.nemostation.android.fulllolwallpaper.Categories";
	public static final String PARC_POSITION = "com.nemostation.android.fulllolwallpaper.Position";
	public static final String PARC_DATA_HOLDER = "com.nemostation.android.fulllolwallpaper.DataHolder";
	...
	private static final int MAX_URL_PER_LOAD = 500;
	...
	public static boolean verifyStoragePermissions(Activity activity) {
		// Check if we have read or write permissionret
	...
	public DataHolder StringCron (DataHolder inDataHolder, int position, int max_load) {
		DataHolder outDataHolder;
		outDataHolder = inDataHolder;
		outDataHolder.getRecent();
