...
import com.wallzstudio.mikuwallpaper.adapters.GridImageAdapter;
import com.wallzstudio.mikuwallpaper.models.Categories;
import com.wallzstudio.mikuwallpaper.models.Category;
import com.wallzstudio.mikuwallpaper.models.Recent;
import com.wallzstudio.mikuwallpaper.util.Controller;
import com.wallzstudio.mikuwallpaper.util.DataHolder;
import com.wallzstudio.mikuwallpaper.util.DialogUtils;
...
public class MainActivity extends NavigationDrawerActivity implements
	...
	public static final String PARC_RECENT = "com.wallzstudio.mikuwallpaper.Recent";
	public static final String PARC_FAVOURITES = "com.wallzstudio.mikuwallpaper.Favourites";
	public static final String PARC_CATEGORIES = "com.wallzstudio.mikuwallpaper.Categories";
	public static final String PARC_POSITION = "com.wallzstudio.mikuwallpaper.Position";
	public static final String PARC_DATA_HOLDER = "com.wallzstudio.mikuwallpaper.DataHolder";
	public static final String PARC_DATA_FAVOURITES = "com.wallzstudio.mikuwallpaper.DataHolder.getFavourites()";
	public static final String PARC_RATE_US_CHECK = "com.wallzstudio.mikuwallpaper.RateUsCheck";
	...
	public void setGridAdapter(int position) {
		...
		if (position < NUMBER_OF_FUNCTION_CAT) {
			if (position == 0) {
				...
				intent.setData(Uri
						.parse(getString(R.string.dev_apps)));
