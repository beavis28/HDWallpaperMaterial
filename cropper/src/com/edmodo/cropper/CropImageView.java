    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mBitmap != null) {
            ...
            /*final Rect bitmapRect = ImageViewUtil.getBitmapRectCenterInside(mBitmap.getWidth(),
                                                                            ...
                                                                            mLayoutHeight);*/
//Quoc change
            final Rect bitmapRect = ImageViewUtil.getBitmapRectCenterInside(mLayoutWidth,
                    mLayoutHeight,
                    mLayoutWidth,
                    mLayoutHeight);
    ...
    /*QuocN Created to fix Bitmap.createBitmap returns wrong value for hight and width*/
